...
Web3DEngine.ExtendType( LightControl , Web3DEngine.MonoBehaviour, {
	...
	Start:function(arg){
        ...
        this._createLightUI(0, clickCB, slideCB, '室外光强度');
        this._createLightUI(1, clickCB, slideCB, '室外光冷暖');
        this._createLightUI(2, clickCB, slideCB, '室外光角度');
        ...
        function slideCB(event) {
            ...
            {
                light.gameObject.transform.localEulerAngles = new THREE.Vector3(angle.x,angle.y + (value - 0.5) * 100, angle.z);
            }
