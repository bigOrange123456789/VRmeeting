...
Web3DEngine.ExtendType( Main , Web3DEngine.MonoBehaviour, {
	...
	Start:function(arg){
        ...
        if(peopleNum<40){
        ...
        }else if(peopleNum==1000){//1000=(7+26)//34//
            var seat=new Array();
            ...
            for(var i=0;i<amplify*50;i++) {
                ...
                moveSet(man, positionSave[getOneSeat][0], positionSave[getOneSeat][1], positionSave[getOneSeat][2]);
            }
	...
	Update:function(arg){
        ...
        //rotation1(this.man2,2,0.5);//旋转散步的男人
    },
...
Main.attributes.add( 'directionY_Ref', {
    type: 'entity',
    default: null,
