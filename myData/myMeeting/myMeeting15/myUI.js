...
//天空盒开始
var myW=window.innerWidth,myH=window.innerHeight;
var bg1=new ImageMove('./meeting/bg.jpg',myW,myH,0,0,mypanel10);//new ImageMove('../meeting/1.png',myW,myH,0,0,mypanel10);
//天空盒结束
var myfirsttext2=document.createElement('h1');
myfirsttext2.innerHTML='吉林动画学院第20届VR展会';//'正在加载3D资源，请稍等！';
if(IsPC()) myfirsttext2.style="font-size:30px;color:#e00;position:fixed;top:"+(myH/2-60)+"px;left:"+(myW/2-150)+"px;";
else myfirsttext2.style="font-size:20px;color:#e00;position:fixed;top:"+(myH/2-60)+"px;left:"+(myW/2-150)+"px;";
mypanel10.appendChild(myfirsttext2);

var myfirsttext=document.createElement('h1');
myfirsttext.innerHTML='虚拟现实学院展厅';//'正在加载3D资源，请稍等！';
if(IsPC()) myfirsttext.style="font-size:15px;color:#e00;position:fixed;top:"+(myH/2)+"px;left:"+(myW/2+100)+"px;";
else myfirsttext.style="font-size:10px;color:#e00;position:fixed;top:"+(myH/2)+"px;left:"+(myW/2-150)+"px;";
mypanel10.appendChild(myfirsttext);
